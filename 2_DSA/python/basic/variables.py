...
print_version("still busy2")
print_version("Coding Competition-1")
print_version("D-day for testing")
print_version("ruined...")
print_version("ruined2...")
print_version("ruined3...")